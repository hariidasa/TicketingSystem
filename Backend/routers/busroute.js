...
const trainModel = require('../models/bus')
...
router.get('/busroute/routes', async (req, res) => {
    try {
...
router.get('/busroute/route/:id', async (req, res) => {
    try {
...
router.get('/busroute/buses', async (req, res) => {
    try {
...
router.get('/busroute/buses/:route', async (req, res) => {
    try {
...
router.get('/busroute/classes', async (req, res) => {
    try {
...
router.get('/busroute/schedules', async (req, res) => {
    try {
...
router.post('/busroute/reservations', async (req, res) => {
    try {
        const body = req.body
...
router.get('/busroute/reservations', async (req, res) => {
    try {
...
router.get('/busroute/users/:user/reservations', async (req, res) => {
    try {
...
router.get('/busroute/reservations/buses/:bus/class/:trainClass/date/:date/time/:time', async (req, res) => {
    try {
...
router.get('/busroute/reservations/:id', async (req, res) => {
    try {
...
router.delete('/busroute/reservations/:id', async (req, res) => {
    try {
...
router.post('/busroute/route', async (req, res) => {
...
router.put('/busroute/route', async (req, res) => {
...
router.post('/busroute/bus', async (req, res) => {
...
router.delete('/busroute/bus', async (req, res) => {
...
router.delete('/busroute/route', async (req, res) => {
...
router.post("/busroute/reservations/monthly", (req, res) => {
...
router.post("/busroute/reservations/yearly", (req, res) => {
