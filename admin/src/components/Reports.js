...
class Reports extends React.Component {
    ...
    handleSubmitOne = (event) => {
        ...
        fetch(config.baseUrl + "/transroute/reservations/yearly", option).then(res => res.json()).then(data => {
    ...
    handleSubmitTwo = (event) => {
        ...
        fetch(config.baseUrl + "/transroute/reservations/monthly", option).then(res => res.json()).then(data => {
            this.props.history.push("/reportCharts", {res: data})
        })
